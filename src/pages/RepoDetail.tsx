...
const RepoDetail = () => {
  ...
  return (
    <div className="p-4 bg-[#d1c9c9] w-fit rounded-lg shadow-lg">
      {repo ? (
        <>
          ...
          <button onClick={() => setShowConfirmationModal(true)} className="mt-4 px-4 py-2 bg-red-500 text-white rounded-lg">
            Delete Repository
          </button>
          {showUpdateModal && (
